...
//    }
     ...
     * @param linkExpiry
     */
    public void config(View buttonElement, Activity context, String url, String customUrl, String pin, String clickCount, String linkExpiry, String userKey) {
...
//
            ...
            jsonObject.put("linkExpiry", linkExpiry);
            jsonObject.put("app", "fasta_sshort");
        } catch (JSONException e) {
            e.printStackTrace();
        }
     ...
     * @param linkExpiry
     */
    public void initWithConfig(View buttonElement, Activity context, String url, String customUrl, String pin, String clickCount, String linkExpiry, String userKey) {
        config(buttonElement, context, url, customUrl, pin, clickCount, linkExpiry, userKey);
        init();
    }
...
//        config(options);
     ...
     * @param pin
     * @param clickCount
     * @param expiry     expire in format yyyyMMddHHmm in UTC
     * @param callback
     */
    public void shortenLink(Activity activity, String url, String customUrl, String pin, String clickCount, String expiry, String userKey, CallbackImpl callback) {
        initWithConfig(null, activity, url, customUrl, pin, clickCount, expiry, userKey);
        ...
        requestDetails.put("max_clicks", clickCount);
        requestDetails.put("expire_date_time", expiry);
